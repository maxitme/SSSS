...
export default function ExportWarehouseDetails() {
          ...
          <main className={style.main}>
            <div className={style.tableContainer}>
              <div className={style.header}>
                <Link
                  href="/admin/dashboard/exportwarehouse"
                  className={style.buttonGray}
                >
                  Quay lại danh sách đơn xuất hàng
                </Link>
              ...
              <div className={style.zone}>
                ...
                <div className={style.selectOrder}>
                  <span>Thông tin đơn xuất hàng</span>
